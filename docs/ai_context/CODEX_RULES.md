...
- Do not move BLE parsing, relay routing, backlog sync ACK policy, or SOS orchestration into widgets.
- Do not break existing SOS, BLE, DMP, protection, backlog sync, or relay flows.
