...
void main() {
  group('SosStateMachine', () {
    ...
    final invalidTransitions = <({SosState from, SosState to})>[
      ...
      (from: SosState.resolved, to: SosState.sent),
      (from: SosState.resolved, to: SosState.acknowledged),
      (from: SosState.cancelled, to: SosState.triggerRequested),
      (from: SosState.cancelled, to: SosState.sent),
      (from: SosState.cancelled, to: SosState.acknowledged),
